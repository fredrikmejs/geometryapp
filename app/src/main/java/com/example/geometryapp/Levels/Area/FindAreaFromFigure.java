...
public class FindAreaFromFigure implements Level {
    ...
    private int xScale;
    private int yScale;
    private Categories category = FINDAREAFROMFIGURE;
    ...
    public FindAreaFromFigure(int levelNum) {
        if (levelNum == 0) {
    ...
    private boolean isCoordinatesOnGrid(int width, int height, Coordinate bottomLeft) {
        if (bottomLeft.getY() + height > 9) {
            return false;
        }
        if (bottomLeft.getX() + width > 9) {
            return false;
        }
        if (bottomLeft.getY() + height < 1) {
            return false;
        }
        if (bottomLeft.getX() + width < 1) {
            return false;
        }
        return true;
    }
